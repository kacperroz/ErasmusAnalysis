---
title: "Analysis of Spanish outgoing Erasmus students"
...
```{r echo=FALSE, eval=TRUE, tidy=TRUE, message=FALSE}
#stuff to load
...
hist(student_age, xlab = "Age of students", main = "Histogram of students' age", ylab = "Number of students", xlim = c(18,30), freq = 1, breaks = 49, col = "lightblue")
```
Oldest Erasmus student is 67 years old!
...
barplot(top5cities$freq, main = "Top 5 universities", xlab = "University", ylab = "Students" , names.arg = top5cities$x, col = "lightblue", cex.names = 0.4)
